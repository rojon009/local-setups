...
# Toggle/cycle through Cursor windows
# - If not on Cursor: focus the most recently used Cursor window
# - If on Cursor: cycle to the next Cursor window

APP_CLASS="cursor.Cursor"
LAUNCH_CMD="cursor"
