...
# Toggle/cycle through Warp terminal windows
# - If not on Warp: focus the most recently used Warp window
# - If on Warp: cycle to the next Warp window

APP_CLASS="dev.warp.Warp"
LAUNCH_CMD="warp-terminal"
