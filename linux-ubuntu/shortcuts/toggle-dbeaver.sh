...
# Toggle/cycle through DBeaver windows
# - If not on DBeaver: focus the most recently used DBeaver window
# - If on DBeaver: cycle to the next DBeaver window

APP_CLASS="DBeaver.DBeaver"
LAUNCH_CMD="dbeaver"
