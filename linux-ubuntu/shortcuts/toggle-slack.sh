...
# Toggle/cycle through Slack windows
# - If not on Slack: focus the most recently used Slack window
# - If on Slack: cycle to the next Slack window

APP_CLASS="slack.Slack"
LAUNCH_CMD="slack"
